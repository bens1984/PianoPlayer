...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 219.0, 73.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 219.0, 73.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "button",
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 95.0, 292.0, 20.0, 20.0 ],
									"id" : "obj-22",
									"numinlets" : 1,
									"numoutlets" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"fontname" : "Arial",
									"patching_rect" : [ 95.0, 369.0, 32.5, 20.0 ],
									"id" : "obj-18",
									"numinlets" : 2,
									"numoutlets" : 1,
									"fontsize" : 12.0
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"fontname" : "Arial",
									"patching_rect" : [ 95.0, 343.0, 32.5, 20.0 ],
									"id" : "obj-17",
									"numinlets" : 2,
									"numoutlets" : 1,
									"fontsize" : 12.0
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"fontname" : "Arial",
									"patching_rect" : [ 95.0, 318.0, 61.0, 20.0 ],
									"id" : "obj-16",
									"numinlets" : 2,
									"numoutlets" : 1,
									"fontsize" : 12.0
...
, 							{
								"box" : 								{
									...
									"text" : "print",
									"fontname" : "Arial",
									"patching_rect" : [ 255.0, 296.0, 34.0, 20.0 ],
									"id" : "obj-13",
									"numinlets" : 1,
									"numoutlets" : 0,
									"fontsize" : 12.0
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"patching_rect" : [ 95.0, 394.0, 110.0, 20.0 ],
									"id" : "obj-20",
									"numinlets" : 3,
									"numoutlets" : 2,
									"fontsize" : 12.0
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 195.5, 417.0, 120.5, 417.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 288.0, 545.0, 57.0, 18.0 ],
					"id" : "obj-26",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0
