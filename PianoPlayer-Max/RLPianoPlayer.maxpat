...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 18.0, 186.0, 1460.0, 976.0 ],
						"bglocked" : 0,
						"defrect" : [ 18.0, 186.0, 1460.0, 976.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "float" ],
													"fontname" : "Arial",
													"patching_rect" : [ 195.0, 135.0, 35.0, 20.0 ],
													"id" : "obj-29",
													"numinlets" : 2,
													"numoutlets" : 1,
													"fontsize" : 12.0
...
, 											{
												"box" : 												{
													"maxclass" : "message",
													"text" : "setcell 127 0 val 1 0.916667 0.183703 0.078736",
													"linecount" : 2,
													"outlettype" : [ "" ],
													"fontname" : "Arial",
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "float" ],
													"fontname" : "Arial",
													"patching_rect" : [ 120.0, 137.0, 35.0, 20.0 ],
													"id" : "obj-9",
													"numinlets" : 2,
													"numoutlets" : 1,
													"fontsize" : 12.0
