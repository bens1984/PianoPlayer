{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1276.0, 59.0, 1248.0, 750.0 ],
		"bglocked" : 0,
		"defrect" : [ 1276.0, 59.0, 1248.0, 750.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 0.0, 100.0, 1460.0, 976.0 ],
						"bglocked" : 0,
						"defrect" : [ 0.0, 100.0, 1460.0, 976.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "setcell 127 0 val 1 0.916667 0.348136 0.166846",
									"linecount" : 2,
									"outlettype" : [ "" ],
									"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "print",
					"fontname" : "Arial",
					"patching_rect" : [ 851.0, 44.0, 34.0, 20.0 ],
					"id" : "obj-166",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route /IR /stm /predict /0 /in /predictReward /recency",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 557.0, 42.0, 287.0, 20.0 ],
					"id" : "obj-161",
					"numinlets" : 1,
					"numoutlets" : 8,
					"fontsize" : 12.0
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 643.071411, 66.0, 813.5, 66.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 604.785706, 69.0, 561.5, 69.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 757.928589, 76.0, 893.5, 76.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-16", 0 ],
					"hidden" : 0,
					"midpoints" : [ 796.214294, 222.5, 838.5, 222.5 ]
				}
