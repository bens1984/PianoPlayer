{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 868.0, 651.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 815.0, 651.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 762.0, 651.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 709.0, 651.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "pak /rewardWeight 0.1 0.2 0.4 0.8",
					"fontname" : "Arial",
					"numinlets" : 5,
					"patching_rect" : [ 707.0, 681.0, 190.0, 20.0 ],
					"id" : "obj-41",
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 228.0, 341.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 175.0, 341.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"presentation_rect" : [ 122.0, 341.0, 0.0, 0.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"int" : 1,
					"numinlets" : 2,
					"patching_rect" : [ 444.0, 636.0, 39.0, 32.0 ],
					"id" : "obj-21",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ]
				}
...
, 											{
												"box" : 												{
													"maxclass" : "message",
													"text" : "setcell 127 0 val 1 0.916667 0.124468 0.124468",
													"linecount" : 2,
													"fontname" : "Arial",
													"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 2,
					"patching_rect" : [ 396.0, 680.0, 41.0, 18.0 ],
					"id" : "obj-38",
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 238.0, 642.0, 168.0, 20.0 ],
					"id" : "obj-34",
					"numoutlets" : 0,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 296.0, 660.0, 50.0, 20.0 ],
					"id" : "obj-32",
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"outlettype" : [ "float", "bang" ]
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 2,
					"patching_rect" : [ 296.0, 682.0, 50.0, 18.0 ],
					"id" : "obj-30",
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route /IR /stm /predict /0 /in /predictReward /recency /3rd /3rdSTM /distance /derived /big /upper /rewards /cats",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 556.0, 57.0, 596.0, 20.0 ],
					"id" : "obj-161",
					"numoutlets" : 16,
					"fontsize" : 12.0,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ]
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 2,
					"patching_rect" : [ 66.0, 682.0, 73.0, 18.0 ],
					"id" : "obj-155",
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-153", 0 ],
					"hidden" : 0,
					"midpoints" : [ 305.5, 703.0, 75.5, 703.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-153", 0 ],
					"hidden" : 0,
					"midpoints" : [ 405.5, 702.5, 75.5, 702.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-16", 0 ],
					"hidden" : 0,
					"midpoints" : [ 796.299988, 315.5, 570.5, 315.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 603.966675, 85.0, 766.5, 85.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 757.833313, 91.0, 521.5, 91.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 603.966675, 84.0, 255.5, 84.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 642.43335, 81.0, 537.5, 81.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-16", 0 ],
					"hidden" : 0,
					"midpoints" : [ 873.233337, 315.5, 570.5, 315.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1065.56665, 80.0, 810.5, 80.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1065.56665, 80.0, 1180.5, 80.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1065.56665, 321.0, 1054.5, 321.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 911.700012, 208.5, 831.5, 208.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 1104.033325, 86.0, 1078.766724, 86.0, 1078.766724, 19.0, 1053.5, 19.0 ]
				}
