{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 44.0, 1257.0, 910.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 44.0, 1257.0, 910.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"candycane" : 6,
					"patching_rect" : [ 1037.0, 387.0, 133.0, 381.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 1087.0, 221.0, 150.0, 158.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"numinlets" : 1,
					"patching_rect" : [ 3.0, 784.0, 1215.0, 103.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 1172.0, 548.0, 66.0, 20.0 ],
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"candycane" : 6,
					"patching_rect" : [ 931.0, 85.0, 261.0, 132.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 930.0, 230.0, 138.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 20.0, 172.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 20.0, 172.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-8",
									"numinlets" : 1,
									"patching_rect" : [ 483.0, 28.0, 20.0, 20.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 825.0, 383.0, 182.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 827.0, 361.0, 71.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 761.0, 347.0, 69.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 896.0, 325.0, 173.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 827.0, 324.0, 71.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 827.0, 286.0, 69.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 1153.0, 44.0, 1407.0, 892.0 ],
						"bglocked" : 0,
						"defrect" : [ 1153.0, 44.0, 1407.0, 892.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 											{
												"box" : 												{
													"maxclass" : "message",
													"text" : "setcell 127 0 val 1 0.916667 0.395799 0.573436",
													"linecount" : 2,
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"id" : "obj-18",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1074.357178, 81.0, 940.5, 81.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1074.357178, 81.0, 1181.5, 81.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1181.5, 778.5, 12.5, 778.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1074.357178, 322.0, 1046.5, 322.0 ]
				}
