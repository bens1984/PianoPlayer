{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 192.0, 49.0, 1248.0, 750.0 ],
		"bglocked" : 0,
		"defrect" : [ 192.0, 49.0, 1248.0, 750.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 734.0, 641.0, 34.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-78"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 763.0, 619.0, 217.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-77"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "TODO: Turn on sub-categories of Feature vectors again!",
					"linecount" : 3,
					"fontsize" : 18.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 213.0, 190.0, 69.0 ],
					"fontname" : "Arial",
					"id" : "obj-71"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "How many categories have been created",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 855.0, 535.0, 258.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 786.0, 534.0, 71.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-44"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 786.0, 496.0, 69.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-35"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "How \"over-played\" each category is",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 684.0, 174.0, 150.0, 20.0 ],
									"fontname" : "Arial",
									"id" : "obj-55"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 691.0, 143.0, 150.0, 20.0 ],
									"fontname" : "Arial",
									"id" : "obj-54"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 667.0, 242.0, 150.0, 20.0 ],
									"fontname" : "Arial",
									"id" : "obj-53"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 670.0, 253.0, 150.0, 20.0 ],
									"fontname" : "Arial",
									"id" : "obj-52"
								}
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "jit.matrix 4 float32 128 30 @thru 0",
													"fontsize" : 12.0,
													"numinlets" : 1,
													"numoutlets" : 2,
													"outlettype" : [ "jit_matrix", "" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 203.0, 165.0, 35.0, 20.0 ],
									"fontname" : "Arial",
									"id" : "obj-29"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "setcell 127 0 val 1 0.916667 0.226487 0.226487",
									"linecount" : 2,
									"fontsize" : 12.0,
									"numinlets" : 2,
									"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 887.0, 350.0, 258.0, 34.0 ],
					"fontname" : "Arial",
					"id" : "obj-43"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 911.0, 50.0, 150.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-18"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 897.0, 71.0, 261.0, 132.0 ],
					"size" : 383,
					"id" : "obj-8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 442.0, 327.0, 39.0, 32.0 ],
					"id" : "obj-170"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 855.0, 16.0, 34.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-166"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route /IR /stm /predict /0 /in /predictReward /recency /3rd /3rdSTM",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 10,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 557.0, 42.0, 361.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-161"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 756.5, 76.0, 893.5, 76.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 604.5, 69.0, 561.5, 69.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 642.5, 66.0, 813.5, 66.0 ]
				}
