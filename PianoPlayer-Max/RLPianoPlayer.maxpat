	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/analyze",
					"patching_rect" : [ 233.0, 680.0, 55.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"setstyle" : 3,
					"size" : 4,
					"presentation_rect" : [ 884.0, 417.0, 0.0, 0.0 ],
					"setminmax" : [ 0.0, 4.0 ],
					"id" : "obj-17"
				}
...
, 			{
				"box" : 				{
					...
					"setstyle" : 3,
					"size" : 11,
					"presentation_rect" : [ 1236.0, 536.0, 0.0, 0.0 ],
					"setminmax" : [ 0.0, 0.3 ],
					"id" : "obj-14"
				}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.matrix 4 float32 512 11 @thru 0",
									"patching_rect" : [ 120.0, 271.0, 190.0, 20.0 ],
									"numinlets" : 1,
									"fontsize" : 12.0,
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
...
, 			{
				"box" : 				{
					...
					"setstyle" : 1,
					"size" : 11,
					"presentation_rect" : [ 1179.0, 404.0, 0.0, 0.0 ],
					"setminmax" : [ 0.0, 0.3 ],
					"id" : "obj-7"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 984.0, 327.0, 0.0, 0.0 ],
					"id" : "obj-6",
					"fontname" : "Arial"
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"numoutlets" : 0,
									"presentation_rect" : [ 500.0, 121.0, 0.0, 0.0 ],
									"id" : "obj-37",
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"presentation_rect" : [ 286.0, 170.0, 0.0, 0.0 ],
									"id" : "obj-32",
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "t 0",
									"patching_rect" : [ 354.0, 147.0, 24.0, 20.0 ],
									"numinlets" : 1,
									"fontsize" : 12.0,
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 0.0, 667.0, 367.0, 349.0 ],
						"bglocked" : 0,
						"defrect" : [ 0.0, 667.0, 367.0, 349.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "bang" ],
													"presentation_rect" : [ 112.0, 71.0, 0.0, 0.0 ],
													"id" : "obj-17",
													"fontname" : "Arial"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "bang" ],
													"presentation_rect" : [ 274.0, 73.0, 0.0, 0.0 ],
													"id" : "obj-15",
													"fontname" : "Arial"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "bang" ],
													"presentation_rect" : [ 109.0, 70.0, 0.0, 0.0 ],
													"id" : "obj-14",
													"fontname" : "Arial"
												}
...
, 											{
												"box" : 												{
													"maxclass" : "message",
													"text" : "setcell 127 0 val 1 0.916667 2.034729 3.622608",
													"linecount" : 2,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 75.5, 677.0, 415.0, 677.0, 415.0, 450.0, 436.5, 450.0 ]
				}
